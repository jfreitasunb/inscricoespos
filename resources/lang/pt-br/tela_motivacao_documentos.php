...
return [
    ...
    'complento_historico' => 'Os comprovantes de Bolsas de estudos institucionais, Experiência Acadêmica e Currículo Lattes ou Curriculum Vitae (se o candidato não possuir o Currículo Lattes), podem ser enviados em um único arquivo, junto com o Histórico Escolar do Curso de Graduação concluído ou a concluir para os candidatos ao Curso de Mestrado e Doutorado.',
    'concordancia_1' => 'O solicitante declara formalmente que está de acordo com as ',
    'concordancia_2' => ' e que está ciente que as decisões da Comissão de Seleção da Matemática serão irrecorríveis, admitindo-se pedido de reconsideração para a própria Comissão nas hipóteses de erros procedimentais ou materiais. (declaração feita em observância aos artigos 297-299 do Código Penal Brasileiro)',
    ...
    'comprovante_proficiencia' => 'Certificados de proficiência em língua Inglesa',
    'projeto' => 'Pré-projeto',
];
