...
<html>
    ...
    <body>
        ...
        <h2>Homologação das inscrições para o Programa de Pós-graduação em Matemática - SEMESTRE/ANO</h2>
        <div>
            <p>O Departamento de Matemática torna pública a homologação das inscrições para {{ $texto_cursos_pos }} Acadêmico em Matemática, com início no primeiro período letivo de 2019, conforme item 7.1 do edital nº {{ $edital }}. </p>
        </div>
    </body>
</html>