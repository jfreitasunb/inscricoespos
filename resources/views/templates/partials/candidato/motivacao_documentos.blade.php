...
{!! Form::open(array('route' => 'motivacao.documentos', 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data', 'data-parsley-validate' => '' )) !!}
  ...
  <fieldset class="scheduler-border">
      <div class="row">
        <p> {{ trans('tela_motivacao_documentos.concordancia_1') }} {{ link_to(Storage::disk('local')->url('app/Editais/Edital_MAT_'.$edital.'.pdf'),trans('tela_motivacao_documentos.texto_link_edital'), array('target' => '_blank' )) }} {{ trans('tela_motivacao_documentos.concordancia_2') }}</p>
        <label>
