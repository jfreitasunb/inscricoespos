    ...
    <legend class="scheduler-border">{{trans('tela_escolha_candidato.recomendante')}}</legend>
      <div class="row">
        <div class="col-md-4">
          ...
          {!! Form::text('nome_recomendante[]',null , ['class' => 'emailrecomendante', 'required' => '']) !!}
        </div>
        <div class="col-md-4">
          {!! Form::label('email_1', 'E-mail: ', ['class' => 'control-label']) !!}
          {!! Form::text('email_recomendante[]',null , ['id' => 'email_recomendante_1', 'class' => 'emailrecomendante', 'required' => '', 'data-parsley-type' => 'email']) !!}
        </div>
        <div class="col-md-4">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          ...
          {!! Form::text('email_recomendante[]',null , ['id' => 'email_recomendante_2', 'class' => 'emailrecomendante', 'required' => '', 'data-parsley-type' => 'email']) !!}
        </div>
        <div class="col-md-4">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          ...
          {!! Form::text('email_recomendante[]',null , ['id' => 'email_recomendante_3', 'class' => 'emailrecomendante', 'required' => '', 'data-parsley-type' => 'email']) !!}
        </div>
        <div class="col-md-4">
