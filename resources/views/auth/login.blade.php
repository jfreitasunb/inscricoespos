<x-app-layout>
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <!-- Email Address -->
            <div>
                <x-label for="email" :value="__('tela_login.menu_email')" />
            ...
            <!-- Password -->
            <div class="mt-4">
                <x-label for="password" :value="__('tela_login.menu_senha')" />
            ...
            <div class="block mt-4">
                <label for="remember_me" class="inline-flex items-center">
                    ...
                    <span class="ml-2 text-sm text-gray-600">{{ __('tela_login.menu_rememberme') }}</span>
                </label>
            </div>
