            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    @if($errors->has('inicio_inscricao'))
                        <x-erro-validacao type="danger" message="{{ $errors->first('inicio_inscricao') }}"/>
                    @endif
                </div>
                <div>
                    ...
                    @if($errors->has('fim_inscricao'))
                        <x-erro-validacao type="danger" message="{{ $errors->first('fim_inscricao') }}"/>
                    @endif
                </div>
                <div>
                    ...
                    @if($errors->has('prazo_carta'))
                        <x-erro-validacao type="danger" message="{{ $errors->first('prazo_carta') }}"/>
                    @endif
                </div>
                <div>
                    ...
                    @if($errors->has('data_homologacao'))
                        <x-erro-validacao type="danger" message="{{ $errors->first('data_homologacao') }}"/>
                    @endif
                </div>
                <div>
        ...
        <div class="mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" id="edital_ano" name="edital_ano" class="w-full rounded border-gray-300 focus:border-blue-500 focus:ring-blue-500" value="" required>
                </div>
                <div>
                    <label for="edital_numero" class="block mb-1">Número</label>
                    <input type="text" id="edital_numero" name="edital_numero" class="w-full rounded border-gray-300 focus:border-blue-500 focus:ring-blue-500" value="" required>
                </div>
            </div>
        </div>
