...
class User extends Authenticatable
{
    ...
    {
        return $this->where('ativo',FALSE)->join('dados_pessoais', 'dados_pessoais.id_user','users.id_user')->select('users.id_user', 'dados_pessoais.nome', 'users.email', 'users.user_type', 'users.created_at')->orderBy('users.created_at')->orderBy('dados_pessoais.nome');
    }
