...
class EnviaDocumentosMatriculaController extends BaseController
{
	...
	public function getEnviaDocumentosMatricula(){
		...
		if ($id_inscricao_pos_candidato == $id_inscricao_pos ) {
			...
			if (!$autoriza_inscricao) {
				...
				$candidato_homologado = $homologa->retorna_se_foi_homologado($id_candidato, $id_inscricao_pos);
				...
				$status_selecao = $selecionado->retorna_status_selecionado($id_inscricao_pos, $id_candidato);
				...
				$dados_para_template['id_candidato'] = $id_candidato;
	...
	{	
		...
		$validator = Validator::make(
        	$input_data, 
		        [
		            'arquivos_matricula.*' => 'required|mimes:pdf|max:40000',
