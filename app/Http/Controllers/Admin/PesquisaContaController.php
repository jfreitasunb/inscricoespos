...
use Notification;
use Carbon\Carbon;
use InscricoesPos\Models\{User, ConfiguraInscricaoPos, AreaPosMat, ProgramaPos, RelatorioController, FinalizaInscricao, ContatoRecomendante, DadoRecomendante, DadoPessoalCandidato, EscolhaCandidato, CartaRecomendacao, AssociaEmailsRecomendante};
	...
	public function postPesquisaConta(Request $request)
	{
		...
		switch ($pesquisar_por) {
			...
			default:
				...
				$users = $usuario->retorna_usuario_por_email($termo_pesquisado);
