...
*/
class ContaCartasRecomendantesController extends AdminController
{
	public function getContaCartas()
	{
		return view('templates.partials.admin.lista_contagem_cartas');
	}
